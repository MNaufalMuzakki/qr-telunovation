    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-6 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @else
                        ...
                        <x-nav-link :href="route('tenant.scanner')" :active="request()->routeIs('tenant.scanner')">
                            {{ __('Web Scanner') }}
                        </x-nav-link>
                    @endif
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <span class="text-xs font-semibold px-2.5 py-1 bg-gray-100 text-gray-600 rounded-lg me-3 uppercase tracking-wider">
                    {{ auth()->user()->role }}
                </span>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if(auth()->user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.redemption')" :active="request()->routeIs('admin.redemption*')">
                    {{ __('Redemption Station') }}
                </x-responsive-nav-link>
            @else
                ...
                <x-responsive-nav-link :href="route('tenant.scanner')" :active="request()->routeIs('tenant.scanner')">
                    {{ __('Web Scanner') }}
                </x-responsive-nav-link>
            @endif
        </div>
